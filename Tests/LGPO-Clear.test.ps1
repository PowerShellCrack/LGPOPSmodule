...
Remove-LocalPolicyUserSetting -RegPath 'HKCU:\software\policies\microsoft\office\16.0\outlook\cached mode'
Remove-LocalPolicyUserSetting -RegPath 'HKCU:\software\policies\microsoft\office\16.0\outlook\cached mode' -Name SyncWindowSetting
Remove-LocalPolicyUserSetting -RegPath 'HKCU:\software\policies\microsoft\office\16.0\outlook\cached mode' -Name CalendarSyncWindowSetting
Remove-LocalPolicyUserSetting -RegPath 'HKCU:\software\policies\microsoft\office\16.0\outlook\cached mode' -Name CalendarSyncWindowSettingMonths

# Set the Office Update UI behavior.
Write-Host ("Removing system policy from Office Update UI behavior")
Remove-LocalPolicySetting -RegPath 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate' -Name HideUpdateNotifications
Remove-LocalPolicySetting -RegPath 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate' -Name HideEnableDisableUpdates
